    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="mt-4">
                    <p class="text-gray-900 whitespace-pre-line">{{ $suggestion['content'] }}</p>
                </div>
            </div>
        </div>
