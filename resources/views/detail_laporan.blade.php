                    ...
                    <ul class="space-y-1">
                        ...
                        <li>
                            <form method="POST" action="{{ route('logout') }}" class="m-0">
                                @csrf
                                <button type="submit" class="w-full text-left px-3 py-2 rounded text-red-600 hover:bg-red-50 flex items-center"><svg class="w-6 h-6 mr-4 text-red-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H8m12 0-4 4m4-4-4-4M9 4H7a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h2"/></svg>Log Out</button>
                            </form>
                        </li>
                    </ul>
                </nav>
        ...
        <div id="mobileSidebar" class="fixed inset-y-0 left-0 z-40 w-64 transform -translate-x-full md:hidden" aria-hidden="true">
            <div class="bg-white h-full p-4 border-r">
                ...
                <nav>
                    <ul class="space-y-1">
                        <li><a href="/dashboard" class="flex items-center px-3 py-2 rounded hover:bg-slate-100"><span class="inline-block w-3.5 h-3.5 bg-slate-300 rounded-full mr-4"></span>Dashboard</a></li>
                        <li><a href="/reports" class="flex items-center px-3 py-2 rounded hover:bg-slate-100"><span class="inline-block w-3.5 h-3.5 bg-slate-300 rounded-full mr-4"></span>Daftar Laporan</a></li>
                        <li><a href="/kotak-saran" class="flex items-center px-3 py-2 rounded hover:bg-slate-100"><span class="inline-block w-3.5 h-3.5 bg-slate-300 rounded-full mr-4"></span>Kotak Saran</a></li>
                        <li>
                            <form method="POST" action="{{ route('logout') }}" class="m-0">
                                @csrf
                                <button type="submit" class="w-full text-left px-3 py-2 rounded text-red-600 hover:bg-red-50 flex items-center"><span class="inline-block w-3.5 h-3.5 bg-red-600 rounded-full mr-4"></span>Keluar</button>
                            </form>
                        </li>
                    </ul>
                </nav>
